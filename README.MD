...
Install <a href="https://github.com/infinitered/reactotron/blob/master/docs/installing.md" target="_blank">Reactotron Client</a> and add your store observers or all state using: `"\*", "root" , "all"`.
